...
export const today = {
  ...
  calories: { value: 2436, goal: 2800, active: 842, resting: 1594 },
  distanceKm: 9.2,
  floors: { value: 18, goal: 12, descended: 14 },
  intensityMin: { value: 64, goal: 150, weekly: 312, weeklyGoal: 150 },
  hydrationMl: { value: 1850, goal: 2500, sweatLossMl: 640 },
  restingHr: 48,
  currentHr: 62,
  minHr: 44,
  maxHr: 172,
...
export const training = {
  ...
  chronicLoad: 588,
  loadRatio: 1.09,
  loadFocus: { anaerobic: 18, highAerobic: 34, lowAerobic: 48 }, // %
  recoveryH: 18,
  readiness: 82,
  readinessLevel: 'Alta',
  readinessFactors: [
    { name: 'Sonno', value: 86, color: '#9b8cff' },
    { name: 'Recupero HRV', value: 78, color: '#3ee6d0' },
    { name: 'Carico acuto', value: 72, color: '#ffc15e' },
    { name: 'Stress', value: 88, color: '#56b0ff' },
  ],
  enduranceScore: 7240,
  hillScore: 62,
  racePredictor: [
